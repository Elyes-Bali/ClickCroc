...
const CustomSlide = ({ Subtext, imgSrc, text, buttonLink, buttonText }) => (
  ...
  >
    ...
    >
      ...
      <Link to="/market">
        <button className="btn btn-primary rounded-pill text-white text-lg font-bodyFont w-[185px] h-[50px] hover:bg-black duration-300 font-bold">
          {buttonText}
        </button>
      </Link>
    </div>
